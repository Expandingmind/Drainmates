...
function ReviewCard({ testimonial }: { testimonial: typeof TESTIMONIALS_ROW_1[0] }) {
  return (
    <div className="flex-shrink-0 w-[260px] md:w-[280px] bg-[#1a1a1a] rounded-xl p-5 border border-white/10 mx-2">
      {/* Header */}
      <div className="flex items-start justify-between mb-3">
        <GoogleIcon />
        <div className="w-7 h-7 rounded-full bg-gray-700 flex items-center justify-center text-white text-xs font-medium">
          {testimonial.initial}
        </div>
      </div>
      ...
      <p className={`text-xs font-medium mb-3 ${testimonial.roleColor}`}>{testimonial.role}</p>

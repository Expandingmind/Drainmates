...
export const metadata = {
  ...
  description: 'Professional plumbing services in Miami-Dade, Broward, Palm Beach, Orange, Seminole & Osceola County. Drain cleaning, leak repair, water heater installation, and 24/7 emergency service.',
}
